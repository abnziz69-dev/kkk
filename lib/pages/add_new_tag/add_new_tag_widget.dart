...
class _AddNewTagWidgetState extends State<AddNewTagWidget> {
  ...
  void initState() {
    ...
    _model.partNoTextController ??= TextEditingController();
    _model.partNoFocusNode ??= FocusNode();
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                width: 200.0,
                                child: TextFormField(
                                  controller: _model.partNoTextController,
                                  focusNode: _model.partNoFocusNode,
                                  autofocus: false,
                                  enabled: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
